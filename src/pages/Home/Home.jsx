  ...
  return (
    <div>
      <div className='flex items-center justify-center gap-10 mt-20'  >
        ...
        <Link to={"/settings"} className='border p-10 rounded-lg btn'>
          <p className='flex items-center justify-center gap-5'><PiGear className='text-3xl' /><span className='text-xl'>Settings</span></p>
        </Link>
      </div>
    </div>
  )
