    ...
    <div>
      ...
      <div className='mt-14 w-[80%] mx-auto'>
        <div className='flex flex-row-reverse justify-between'>
          ...
          <div>
            <button className="btn" onClick={() => document.getElementById('new_item_register_modal').showModal()}><PiPlusSquare className='text-xl mr-2' /> <span className=''>New Item</span></button>
            <dialog id="new_item_register_modal" className="modal">
