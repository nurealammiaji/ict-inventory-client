        ...
        <div>
            ...
            <div className='mt-14 w-[80%] mx-auto'>
                <div className='flex flex-row-reverse justify-between'>
                    ...
                    <div>
                        <button className="btn" onClick={() => document.getElementById('new_loan_register_modal').showModal()}><PiPlusSquare className='text-xl mr-2' /> <span className=''>New Loan</span></button>
